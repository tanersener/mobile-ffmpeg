...
cmake -Wno-dev \
    ...
    -DCMAKE_INSTALL_PREFIX="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/libwebp" \
    ...
    -DGIF_INCLUDE_DIR="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/giflib/include" \
    -DGIF_LIBRARY="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/giflib/lib" \
    -DJPEG_INCLUDE_DIR="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/jpeg/include" \
    -DJPEG_LIBRARY="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/jpeg/lib" \
    -DPNG_PNG_INCLUDE_DIR="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/libpng/include" \
    -DPNG_LIBRARY="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/libpng/lib" \
    -DTIFF_INCLUDE_DIR="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/tiff/include" \
    -DTIFF_LIBRARY="${ANDROID_NDK_ROOT}/prebuilt/android-$(get_target_build)/tiff/lib" \
