...
FFMPEG_CFLAGS=""
FFMPEG_LDFLAGS=""
export PKG_CONFIG_LIBDIR="${BASEDIR}/prebuilt/$(get_target_build_directory)/pkgconfig"
...
if [ ${ARCH} == "x86-64-mac-catalyst" ] || [ ${ARCH} == "arm64-mac-catalyst" ]; then
...
cp -f ${BASEDIR}/src/ffmpeg/config.h ${BASEDIR}/prebuilt/$(get_target_build_directory)/ffmpeg/include/config-${arch}.h
