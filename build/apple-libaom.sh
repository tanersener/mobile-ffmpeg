...
case ${ARCH} in
    ...
    ;;
    x86-64-*)
        cp ${BASEDIR}/tools/cmake/libaom.x86_64-apple.cmake ${BASEDIR}/src/${LIB_NAME}/build/cmake/toolchains/x86_64-apple.cmake
        TOOLCHAIN_FILE="${BASEDIR}/src/${LIB_NAME}/build/cmake/toolchains/x86_64-apple.cmake"
        ARCH_OPTIONS="-DARCH_X86_64=1 -DENABLE_SSE=1 -DENABLE_SSE2=1 -DENABLE_SSE3=1 -DENABLE_SSE4_1=1 -DENABLE_SSE4_2=1 -DENABLE_MMX=1 -DCONFIG_OS_SUPPORT=0 -DCONFIG_RUNTIME_CPU_DETECT=0"
    ;;
    arm64-*)
	    cp ${BASEDIR}/tools/cmake/libaom.arm64-apple.cmake ${BASEDIR}/src/${LIB_NAME}/build/cmake/toolchains/arm64-apple.cmake
        TOOLCHAIN_FILE="${BASEDIR}/src/${LIB_NAME}/build/cmake/toolchains/arm64-apple.cmake"
	    ARCH_OPTIONS="-DARCH_ARM=1 -DENABLE_NEON=1 -DHAVE_NEON=1 -DCONFIG_OS_SUPPORT=0 -DCONFIG_RUNTIME_CPU_DETECT=0" 
    ;;
esac
...
if [[ ${ARCH} == *-mac-catalyst ]] || [[ ${ARCH} == *-macos ]]; then
