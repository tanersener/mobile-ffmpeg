...
typedef enum {
    ...
    INDEX_OPT_MAXEARLYDATA                 =  7,
    INDEX_OPT_NOCOOKIE                     =  8,
    INDEX_OPT_GENERATE                     =  9,
    INDEX_OPT_QUIET                        = 10,
    INDEX_OPT_NODB                         = 11,
    INDEX_OPT_HTTP                         = 12,
    INDEX_OPT_ECHO                         = 13,
    INDEX_OPT_UDP                          = 14,
    INDEX_OPT_MTU                          = 15,
    INDEX_OPT_SRTP_PROFILES                = 16,
    INDEX_OPT_DISABLE_CLIENT_CERT          = 17,
    INDEX_OPT_REQUIRE_CLIENT_CERT          = 18,
    INDEX_OPT_VERIFY_CLIENT_CERT           = 19,
    INDEX_OPT_HEARTBEAT                    = 20,
    INDEX_OPT_X509FMTDER                   = 21,
    INDEX_OPT_PRIORITY                     = 22,
    INDEX_OPT_DHPARAMS                     = 23,
    INDEX_OPT_X509CAFILE                   = 24,
    INDEX_OPT_X509CRLFILE                  = 25,
    INDEX_OPT_PGPKEYFILE                   = 26,
    INDEX_OPT_X509KEYFILE                  = 27,
    INDEX_OPT_X509CERTFILE                 = 28,
    INDEX_OPT_X509DSAKEYFILE               = 29,
    INDEX_OPT_X509DSACERTFILE              = 30,
    INDEX_OPT_X509ECCKEYFILE               = 31,
    INDEX_OPT_X509ECCCERTFILE              = 32,
    INDEX_OPT_SRPPASSWD                    = 33,
    INDEX_OPT_SRPPASSWDCONF                = 34,
    INDEX_OPT_PSKPASSWD                    = 35,
    INDEX_OPT_PSKHINT                      = 36,
    INDEX_OPT_OCSP_RESPONSE                = 37,
    INDEX_OPT_IGNORE_OCSP_RESPONSE_ERRORS  = 38,
    INDEX_OPT_PORT                         = 39,
    INDEX_OPT_LIST                         = 40,
    INDEX_OPT_PROVIDER                     = 41,
    INDEX_OPT_KEYMATEXPORT                 = 42,
    INDEX_OPT_KEYMATEXPORTSIZE             = 43,
...
#define OPTION_CT    47
/** gnutls-serv version */
#define GNUTLS_SERV_VERSION       "3.6.8"
/** Full gnutls-serv version text */
#define GNUTLS_SERV_FULL_VERSION  "gnutls-serv 3.6.8"
...
#define VALUE_OPT_MAXEARLYDATA   0x1007

#define OPT_VALUE_MAXEARLYDATA   (DESC(MAXEARLYDATA).optArg.argInt)
#define VALUE_OPT_NOCOOKIE       0x1008
#define VALUE_OPT_GENERATE       'g'
#define VALUE_OPT_QUIET          'q'
#define VALUE_OPT_NODB           0x1009
#define VALUE_OPT_HTTP           0x100A
#define VALUE_OPT_ECHO           0x100B
#define VALUE_OPT_UDP            'u'
#define VALUE_OPT_MTU            0x100C

#define OPT_VALUE_MTU            (DESC(MTU).optArg.argInt)
#define VALUE_OPT_SRTP_PROFILES  0x100D
#define VALUE_OPT_DISABLE_CLIENT_CERT 'a'
#define VALUE_OPT_REQUIRE_CLIENT_CERT 'r'
#define VALUE_OPT_VERIFY_CLIENT_CERT 0x100E
#define VALUE_OPT_HEARTBEAT      'b'
#define VALUE_OPT_X509FMTDER     0x100F
#define VALUE_OPT_PRIORITY       0x1010
#define VALUE_OPT_DHPARAMS       0x1011
...
#define VALUE_OPT_X509DSAKEYFILE 0x1017
#define VALUE_OPT_X509DSACERTFILE 0x1018
#define VALUE_OPT_X509ECCKEYFILE 0x1019
#define VALUE_OPT_X509ECCCERTFILE 0x101A
#define VALUE_OPT_SRPPASSWD      0x101B
#define VALUE_OPT_SRPPASSWDCONF  0x101C
#define VALUE_OPT_PSKPASSWD      0x101D
#define VALUE_OPT_PSKHINT        0x101E
#define VALUE_OPT_OCSP_RESPONSE  0x101F
#define VALUE_OPT_IGNORE_OCSP_RESPONSE_ERRORS 0x1020
#define VALUE_OPT_PORT           'p'

#define OPT_VALUE_PORT           (DESC(PORT).optArg.argInt)
#define VALUE_OPT_LIST           'l'
#define VALUE_OPT_PROVIDER       0x1021
#define VALUE_OPT_KEYMATEXPORT   0x1022
#define VALUE_OPT_KEYMATEXPORTSIZE 0x1023
