...
if [[ ! -z ${TARGET_ARCH_LIST} ]]; then
    ...
    do
        ...
        do
            ...
            install_name_tool -change @rpath/libavutil.dylib @rpath/libavcodec.framework/libavcodec ${BASEDIR}/prebuilt/ios-framework/${ONE_LIB}.framework/${ONE_LIB} 1>>${BASEDIR}/build.log 2>&1
