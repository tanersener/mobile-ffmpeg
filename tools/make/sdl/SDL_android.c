...
/*
 * CHANGES 07.2020
 * - JNI_OnLoad renamed as SDL_Android_Initialize
 * - SDL_main replaced with mobile_ffmpeg_ffplay_execute
 * - All native methods moved under FFplay class
 * - Added Android logging macros
 */
...
#define SDL_JAVA_PREFIX                                 com_arthenica_mobileffmpeg
#define CONCAT1(prefix, class, function)                CONCAT2(prefix, class, function)
#define CONCAT2(prefix, class, function)                Java_ ## prefix ## _ ## class ## _ ## function
#define SDL_JAVA_INTERFACE(function)                    CONCAT1(SDL_JAVA_PREFIX, FFplay, function)
#define SDL_JAVA_AUDIO_INTERFACE(function)              CONCAT1(SDL_JAVA_PREFIX, FFplay, function)
#define SDL_JAVA_CONTROLLER_INTERFACE(function)         CONCAT1(SDL_JAVA_PREFIX, FFplay, function)
#define SDL_JAVA_INTERFACE_INPUT_CONNECTION(function)   CONCAT1(SDL_JAVA_PREFIX, FFplay, function)


/* Java class Player */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerInit)(JNIEnv* mEnv, jclass cls);

JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativePlayerRun)(JNIEnv* env, jclass cls, jobjectArray array);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnDropFile)(JNIEnv* env, jclass jcls, jstring filename);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnResize)(JNIEnv* env, jclass jcls,
        jint width, jint height, jint format, jfloat rate);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnSurfaceChanged)(JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnSurfaceDestroyed)(JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnKeyDown)(JNIEnv* env, jclass jcls, jint keycode);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnKeyUp)(JNIEnv* env, jclass jcls, jint keycode);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnKeyboardFocusLost)(JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnTouch)(JNIEnv* env, jclass jcls,
        jint touch_device_id_in, jint pointer_finger_id_in, jint action, jfloat x, jfloat y, jfloat p);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnMouse)(JNIEnv* env, jclass jcls,
        jint button, jint action, jfloat x, jfloat y);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnAccel)(JNIEnv* env, jclass jcls, jfloat x, jfloat y, jfloat z);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnClipboardChanged)(JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeLowMemory)(JNIEnv* env, jclass cls);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeQuit)(JNIEnv* env, jclass cls);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativePause)(JNIEnv* env, jclass cls);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeResume)(JNIEnv* env, jclass cls);

JNIEXPORT jstring JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeGetHint)(JNIEnv* env, jclass cls, jstring name);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeSetenv)(JNIEnv* env, jclass cls,
        jstring name, jstring value);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeEnvironmentVariablesSet)(JNIEnv* env, jclass cls);

/* Java class Input */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE_INPUT_CONNECTION(nativeInputCommitText)(JNIEnv* env, jclass cls,
        jstring text, jint newCursorPosition);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE_INPUT_CONNECTION(nativeInputGenerateScancodeForUnichar)(
        JNIEnv* env, jclass cls, jchar chUnicode);

JNIEXPORT void JNICALL SDL_JAVA_INTERFACE_INPUT_CONNECTION(nativeInputSetComposingText)(
        JNIEnv* env, jclass cls, jstring text, jint newCursorPosition);

/* Java class Audio */
JNIEXPORT void JNICALL SDL_JAVA_AUDIO_INTERFACE(nativeAudioInit)(JNIEnv *env, jclass jcls);

/* Java class Controller */
JNIEXPORT void JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerInit)(JNIEnv *env, jclass jcls);

JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnPadDown)(JNIEnv* env, jclass jcls,
        jint device_id, jint keycode);

JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnPadUp)(JNIEnv* env, jclass jcls,
        jint device_id, jint keycode);

JNIEXPORT void JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnJoy)( JNIEnv* env, jclass jcls,
        jint device_id, jint axis, jfloat value);

JNIEXPORT void JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnHat)(JNIEnv* env, jclass jcls,
        jint device_id, jint hat_id, jint x, jint y);

JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerAddJoystick)(
        JNIEnv* env, jclass jcls,
        jint device_id, jstring device_name, jstring device_desc, jint is_accelerometer,
        jint nbuttons, jint naxes, jint nhats, jint nballs);

JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerRemoveJoystick)(
        JNIEnv* env, jclass jcls, jint device_id);

JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerAddHaptic)(JNIEnv* env, jclass jcls,
        jint device_id, jstring device_name);

JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerRemoveHaptic)(
        JNIEnv* env, jclass jcls, jint device_id);
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerInit)(JNIEnv* mEnv, jclass cls)
{
    ...
    if (!midGetNativeSurface ||
       ...
       !midOpenAPKExpansionInputStream || !midGetManifestEnvironmentVariables|| !midGetDisplayDPI) {
        LOGW("Missing some Java callbacks, do you have the latest version of Player?");
    }

    fidSeparateMouseAndTouch = (*mEnv)->GetStaticFieldID(mEnv, mActivityClass, "separateMouseAndTouch", "Z");

    if (!fidSeparateMouseAndTouch) {
        LOGW("Missing some Java static fields, do you have the latest version of Player?");
    }
...
JNIEXPORT void JNICALL SDL_JAVA_AUDIO_INTERFACE(nativeAudioInit)(JNIEnv* mEnv, jclass cls)
{
    Android_JNI_SetupThread();
    ...
    if (!midAudioOpen || !midAudioWriteShortBuffer || !midAudioWriteByteBuffer || !midAudioClose ||
       !midCaptureOpen || !midCaptureReadShortBuffer || !midCaptureReadByteBuffer || !midCaptureClose) {
        LOGW("Missing some Java callbacks, do you have the latest version of Audio?");
    }
...
JNIEXPORT void JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerInit)(JNIEnv* mEnv, jclass cls)
{
    Android_JNI_SetupThread();
    ...
    if (!midPollInputDevices || !midPollHapticDevices || !midHapticRun) {
        LOGW("Missing some Java callbacks, do you have the latest version of Controller?");
    }

    checkJNIReady();
}

/* ffplay_execute function prototype */
static int (*mobile_ffmpeg_ffplay_execute)(int argc, char **argv) = NULL;

/* ffplay_execute setter */
void set_mobile_ffmpeg_ffplay_execute(int (*ffplay_execute_function)(int argc, char **argv))
{
    mobile_ffmpeg_ffplay_execute = ffplay_execute_function;
}
...
JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativePlayerRun)(JNIEnv* env, jclass cls, jobjectArray array)
{
    ...
    if (mobile_ffmpeg_ffplay_execute != NULL) {
        int i;
        int argc;
        int len;
        char **argv;
        ...
        /* Run the application. */
        status = mobile_ffmpeg_ffplay_execute(argc, argv);
        ...
        LOGE("execute function is not set.");
    }
...
/* Resize */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnResize)(
                                    JNIEnv* env, jclass jcls, jint width, jint height, jint format, jfloat rate)
{
    Android_SetScreenResolution(width, height, format, rate);
}

/* Paddown */
JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnPadDown)(
...
/* Padup */
JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnPadUp)(
                                    JNIEnv* env, jclass jcls, jint device_id, jint keycode)
{
...
/* Joy */
JNIEXPORT void JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnJoy)(
...
/* POV Hat */
JNIEXPORT void JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerOnHat)(
...
JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeControllerAddHaptic)(
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnSurfaceChanged)(JNIEnv* env, jclass jcls)
{
    ...
    /* If the surface has been previously destroyed by nativePlayerOnSurfaceDestroyed, recreate it here */
...
/* Touch */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnTouch)(
                                    JNIEnv* env, jclass jcls,
...
/* Mouse */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerOnMouse)(
                                    JNIEnv* env, jclass jcls, jint button, jint action, jfloat x, jfloat y)
{
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeQuit)(JNIEnv* env, jclass cls)
{
     ...
     * in SDL_APP_WILLENTERBACKGROUND. After nativePlayerNativeQuit() is called, no
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE_INPUT_CONNECTION(nativeInputCommitText)(
                                    JNIEnv* env, jclass cls, jstring text, jint newCursorPosition)
{
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePlayerNativeSetenv)(
