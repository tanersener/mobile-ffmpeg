...
create_package "min-gpl" "2.0" || exit 1
...
create_package "https" "2.0" || exit 1
...
create_package "https-gpl" "2.0" || exit 1
...
create_package "full" "2.0" || exit 1
...
create_package "full-gpl" "2.0" || exit 1
