Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v4.0.2 with fontconfig v2.13.0, freetype v2.9.1, fribidi v1.0.5, kvazaar v1.2.0, libaom v2018.08.29-snapshot, libass v0.14.0, libiconv v1.15, libtheora v1.1.1, libvpx v1.7.0 and snappy v1.1.7 libraries enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v2.1/mobile-ffmpeg-video-2.1-ios-framework.zip' }
