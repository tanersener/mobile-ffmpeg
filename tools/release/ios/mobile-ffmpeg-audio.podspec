Pod::Spec.new do |s|  
    ...
    s.description       = <<-DESC
    Includes FFmpeg v4.2-dev-480 with lame v3.100, libilbc v2.0.2, libvorbis v1.3.6, opencore-amr v0.1.5, opus v1.3, shine v3.1.1, soxr v0.1.3, speex v1.2.0, twolame v0.3.13 and wavpack v5.1.0 libraries enabled.
    DESC
