Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v4.0.1 with x264 v20180627-2245-stable and xvidcore v1.3.5 libraries enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v2.0/mobile-ffmpeg-min-gpl-2.0-ios-framework.zip' }
