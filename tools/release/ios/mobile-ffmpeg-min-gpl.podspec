Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v3.4.4 with x264 v20180815-2245-stable and xvidcore v1.3.5 libraries enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v1.2/mobile-ffmpeg-min-gpl-1.2-ios-framework.zip' }
