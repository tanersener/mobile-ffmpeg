Pod::Spec.new do |s|  
    ...
    s.description       = <<-DESC
    Includes FFmpeg v4.2-dev-480 with gmp v6.1.2, gnutls v3.5.19, libvid.stab v1.1.0, x264 20181224-2245-stable, x265 v2.9 and xvidcore v1.3.5 libraries enabled.
    DESC
