Pod::Spec.new do |s|  
    ...
    s.description       = <<-DESC
    Includes FFmpeg v4.2-dev-1824 with gmp v6.1.2, gnutls v3.6.8, libvid.stab v1.1.0, x264 20190701-2245-stable, x265 v3.0 and xvidcore v1.3.5 libraries enabled.
    DESC
