Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v3.4.2 with gnutls v3.5.18, x264 v20180606-2245-stable and xvidcore v1.3.5 libraries enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v1.1/mobile-ffmpeg-https-gpl-1.1-ios-framework.zip' }
