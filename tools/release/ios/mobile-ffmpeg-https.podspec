Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v4.1-dev-1517 with gmp v6.1.2 and gnutls v3.5.19 library enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v3.0/mobile-ffmpeg-https-3.0-ios-framework.zip' }
