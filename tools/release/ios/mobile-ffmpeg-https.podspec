Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v4.0.1 with gnutls v3.5.18 library enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v2.0/mobile-ffmpeg-https-2.0-ios-framework.zip' }
