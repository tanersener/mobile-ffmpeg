Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v4.1-10 without any external libraries enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v3.0/mobile-ffmpeg-min-3.0-ios-framework.zip' }
