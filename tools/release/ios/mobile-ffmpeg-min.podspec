Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v4.0.2 without any external libraries enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v2.1/mobile-ffmpeg-min-2.1-ios-framework.zip' }
