Pod::Spec.new do |s|  
    ...
    s.description       = 'Includes FFmpeg v3.4.4 without any external libraries enabled.'
    ...
    s.source            = { :http => 'https://github.com/tanersener/mobile-ffmpeg/releases/download/v1.2/mobile-ffmpeg-min-1.2-ios-framework.zip' }
